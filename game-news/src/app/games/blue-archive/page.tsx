...
import { getBlueArchiveNews } from '@/lib/supabase';
import BlueArchiveClientPage from './BlueArchiveClientPage';
import { NewsItem } from '@/types/news';

export const revalidate = 0; // 每次請求都重新驗證，確保資料最新

export default async function BlueArchivePage({
  searchParams,
}: {
